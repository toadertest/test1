...
public class WeatherContract {
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static long getLatFromUri(Uri uri) {
            String dateString = uri.getQueryParameter(COLUMN_COORD_LAT);
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherLatLngWithDate(String loc, long date) {
            return CONTENT_URI.buildUpon().appendPath(loc).appendPath(Long.toString(normalizeDate(date))).build();
        }

        private static String getStringData(LatLng latLng) {
