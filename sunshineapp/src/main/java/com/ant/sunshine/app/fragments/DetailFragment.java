...
import com.ant.sunshine.app.activities.DetailActivity;
import com.ant.sunshine.app.test.WeatherContract;
import com.ant.sunshine.app.test.WeatherContract.WeatherEntry;
...
public class DetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLocationTextView = (TextView) rootView.findViewById(R.id.tv_detail_location_textview);
        return rootView;
    }
    ...
    public void onLocationChanged(String newLocation) {
        ...
        if (null != uri) {
            ...
            Uri updatedUri = WeatherContract.WeatherEntry.buildWeatherLatLngWithDate(newLocation, date);
            mUri = updatedUri;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (data != null && data.moveToFirst()) {
            ...
            String location = getLocationFromPrefs(getActivity());
